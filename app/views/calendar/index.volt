            ...
            <div class="col-md-12">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="{% if floor_id == 1 %} active {% endif %}"><a href="{{ url.get("calendar/1/index") }}" role="tab" aria-expanded="true">1st floor</a>
                        </li>
                        <li role="presentation" class="{% if floor_id == 2 %} active {% endif %}"><a href="{{ url.get("calendar/2/index") }}" role="tab" aria-expanded="false">2nd floor</a>
                        </li>
                    </ul>
